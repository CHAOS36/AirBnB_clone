...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        hi = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(hi, output.getvalue().strip())

    def test_help_create(self):
        hes = ("Usage: create <class>\n        "
             "Create a new class instance and print its id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(hes, output.getvalue().strip())
    ...
    def test_help_show(self):
        hip = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Display the string representation of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help show"))
            self.assertEqual(hip, output.getvalue().strip())
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_invalid_class(self):
        pipox = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("destroy MyModel"))
            self.assertEqual(pipox, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
