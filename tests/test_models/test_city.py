...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_args_unused(self):
        cry = City(None)
        self.assertNotIn(None, cry.__dict__.values())

    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        cry = City(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(cry.id, "345")
        self.assertEqual(cry.created_at, dt)
        self.assertEqual(cry.updated_at, dt)
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        cry = City()
        cry.id = "123456"
        cry.created_at = cry.updated_at = dt
        tdict = {
            'id': '123456',
            '__class__': 'City',
        ...
        self.assertDictEqual(cry.to_dict(), tdict)

    def test_contrast_to_dict_dunder_dict(self):
        cry = City()
        self.assertNotEqual(cry.to_dict(), cry.__dict__)
