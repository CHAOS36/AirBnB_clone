...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_args_unused(self):
        pipox = Place(None)
        self.assertNotIn(None, pipox.__dict__.values())
...
class TestPlace_save(unittest.TestCase):
    ...
    def test_two_saves(self):
        pipo = Place()
        sleep(0.05)
        first_updated_at = pipo.updated_at
        pipo.save()
        second_updated_at = pipo.updated_at
        self.assertLess(first_updated_at, second_updated_at)
        sleep(0.05)
        pipo.save()
        self.assertLess(second_updated_at, pipo.updated_at)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_contrast_to_dict_dunder_dict(self):
        pi = Place()
        self.assertNotEqual(pi.to_dict(), pi.__dict__)
