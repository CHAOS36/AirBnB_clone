...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_args_unused(self):
        peper = Review(None)
        self.assertNotIn(None, peper.__dict__.values())
...
class TestReview_save(unittest.TestCase):
    ...
    def test_two_saves(self):
        rzv = Review()
        sleep(0.05)
        first_updated_at = rzv.updated_at
        rzv.save()
        second_updated_at = rzv.updated_at
        self.assertLess(first_updated_at, second_updated_at)
        sleep(0.05)
        rzv.save()
        self.assertLess(second_updated_at, rzv.updated_at)
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        rav = Review()
        rav.id = "123456"
        rav.created_at = rav.updated_at = dt
        tdict = {
            'id': '123456',
            '__class__': 'Review',
        ...
        self.assertDictEqual(rav.to_dict(), tdict)

    def test_contrast_to_dict_dunder_dict(self):
        rav = Review()
        self.assertNotEqual(rav.to_dict(), rav.__dict__)
